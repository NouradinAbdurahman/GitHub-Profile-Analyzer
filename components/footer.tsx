    ...
    <footer className="border-t bg-background text-[10px] sm:text-sm max-[530px]:text-sm"> {/* Adjusted for <530px */}
      <div className="max-w-7xl mx-auto px-2 py-4 md:py-6 w-full flex flex-col gap-6 xl:px-12 2xl:px-20">
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-8 md:h-20 w-full xl:gap-16 2xl:gap-24">
          ...
          <div className="flex flex-col items-center md:items-start gap-2 text-[10px] sm:text-sm max-[530px]:text-sm text-muted-foreground min-w-0"> {/* Adjusted for <530px */}
            ...
            <span className="text-center md:text-left text-[10px] sm:text-sm max-[530px]:text-xs">Explore AI-driven GitHub profile analysis, compare users with visual metrics, and gain real-time insights with personalized recommendations.</span> {/* Updated description */}
          </div>
          {/* Center: Nav Links */}
          <nav className="flex flex-row gap-8 text-[10px] sm:text-sm max-[530px]:text-sm text-muted-foreground justify-center items-center min-w-0"> {/* Adjusted for <530px */}
          ...
          <div className="flex flex-col items-center space-y-2 min-w-0">
            ...
            <div className="flex items-center justify-center gap-3 xl:gap-4 2xl:gap-6">
              ...
              >
                <Github className="h-4 w-4 sm:h-6 sm:w-6 max-[530px]:h-5 max-[530px]:w-5 text-[#fff]" /> {/* Adjusted for <530px */}
              </a>
              <a
